(function(){
    ...
    a.register("core.func.getType", function(b){
        return function(c){
            var d;
            return ((d = typeof(c)) == "object" ? c == null && "null" ||
            Object.prototype.toString.call(c).slice(8, -1) : d).toLowerCase()
        }
    });
    ...
    a.register("core.dom.isNode", function(b){
        return function(c){
            return (c != undefined) && Boolean(c.nodeName) &&
            Boolean(c.nodeType)
        }
    });
    ...
    a.register("core.dom.position", function(d){
        ...
        var c = function(g, e){
            ...
            if (d.core.util.browser.OPERA != -1 ||
            (d.core.util.browser.SAFARI != -1 && g.style.position == "absolute")) {
    ...
    a.register("core.dom.removeClassName", function(b){
        return function(d, c){
            if (d.nodeType === 1) {
                if (b.core.dom.hasClassName(d, c)) {
                    d.className = d.className.replace(new RegExp("(^|\\s)" + c +
                    "($|\\s)"), " ")
                }
            }
        }
    ...
    a.register("core.dom.uniqueID", function(b){
        return function(c){
            return c &&
            (c.uniqueID ||
            (c.uniqueID = b.core.util.getUniqueKey()))
        }
    });
    ...
    a.register("core.evt.fixEvent", function(c){
        ...
        return function(g){
            ...
            if (g.pageX == null && g.clientX != null) {
                ...
                var d = document.body;
                g.pageX = g.clientX + (f.scrollLeft || d && d.scrollLeft || 0) -
                (f.clientLeft || d && d.clientLeft || 0);
                g.pageY = g.clientY + (f.scrollTop || d && d.scrollTop || 0) -
                (f.clientTop || d && d.clientTop || 0)
            }
            if (!g.which && g.button) {
                if (g.button & 1) {
                    g.which = 1
            ...
            if (f.onComplete != null) {
                if (c.IE) {
                    g.onreadystatechange = function(){
                        if (g.readyState.toLowerCase() == "loaded" ||
                        g.readyState.toLowerCase() == "complete") {
                            try {
                                clearTimeout(e);
    ...
    a.register("core.json.jsonToStr", function(e){
        ...
        function b(f){
            ...
            f.replace(i, function(m){
                ...
                ("0000" +
                m.charCodeAt(0).toString(16)).slice(-4)
            }) +
            '"' : '"' + f + '"'
        }
        function h(s, p){
    ...
    a.register("kit.dom.appendStyle", function(b){
        return function(f, c){
            ...
            f = f || "";
            f = f.toString();
            if (b.isNode(d.target) &&
            d.target.tagName.toLowerCase() === "style") {
                e = d.target
            }
            else {
    ...
    a.register("module.draggable", function(g){
        ...
        var d = function(j){
            var i = f(j);
            if (g.isNode(j) && g.isNode(i) && i.tagName &&
            i.tagName.toLowerCase() === "body" &&
            g.getStyle(j, "position") === "fixed") {
                return true
            }
            else {
                return false
        ...
        var b = {
            ...
            fixScrollDrag: function(){
                if (this.draging && this.data && this.scrollPos) {
                    var j = g.scrollPos();
                    var i = this.data;
                    i.pageX = i.pageX + j.left -
                    this.scrollPos.left;
                    i.pageY = i.pageY + j.top -
                    this.scrollPos.top;
            ...
            limit: function(n){
                ...
                if (j.dragarea) {
                    ...
                    n.left = Math.max(h(n.left, l.left, l.right -
                    m.offsetWidth), l.left);
                    n.top = Math.max(h(n.top, l.top, l.bottom -
                    m.offsetHeight), l.top)
                }
                return n
            },
    ...
    a.register("kit.dom.placeholder", function(d){
        ...
        return function(h, e){
            ...
            g.compute_offset = function(){
                ...
                j.y = j.marginTop + j.paddingTop + j.borderTopWidth +
                (d.core.util.browser.IE6 ? 1 : 0);
                return j
            };
    ...
    a.register("comp.login.outlogin", function(e){
        ...
        return function(n, q){
            ...
            p.isPhoneTipHide = function(t){
                ...
                p.isInside = e.contains(m.phone_tip, s) ||
                e.contains(m.loginname_box, s) ||
                s == m.phone_tip;
                if (!p.isInside) {
                    p.hidePhoneTip()
                }
            ...
            p.getRemember = function(){
                ...
                if (!s &&
                u &&
                e.getType(u.getLoginInfo) === "function") {
            ...
            p.parseDom = function(){
                ...
                if (s) {
                    ...
                    e.foreach(["root", "tip", "loginname", "password_box", "password", "door_box", "door", "door_img", "vsn_box", "vsn"], function(t){
                        if (!m[t]) {
                            throw ("Can't find necessary node : " +
                            t +
                            " !")
                        }
                    });
                    ...
                    p.log("Can't find login form : " + n.id ||
                    n.getAttribute("noe-type"))
                }
            };
            p.domEvents = {
    ...
    a.register("comp.defaultStyle", function(c){
        var b = [".outlogin_layerbox_bylx,", ".outlogin_layerbox_bylx p,", ".outlogin_layerbox_bylx div,", ".outlogin_layerbox_bylx li,",        //								'.outlogin_layerbox_bylx input{font: 12px/1.125 "Simsun", "Arial Narrow", "HELVETICA"!important;}',
        '.outlogin_layerbox_bylx input{}', '.outlogin_layerbox_bylx a { color: #474747;}', '.outlogin_layerbox_bylx a:hover{color:#FF4400}', '.outlogin_layerbox_bylx.outlogin_layerbox_bylx .hide{display:none;}',        //								".outlogin_layerbox_bylx{width:292px!important;position:absolute;border-width:1px!important;border-style:solid!important;text-align:left!important;}",
        ".outlogin_layerbox_bylx{ background-color: #ffffff; border: 1px solid #dcdcdc; box-shadow: 1px 2px 0 rgba(0, 0, 0, 0.1); height: 230px; padding: 36px 27px 27px; position: absolute; width: 516px;position:absolute;border-width:1px!important;border-style:solid!important;text-align:left!important;color: #474747; font-size: 14px;}", ".outlogin_layerbox_bylx .cur_move{position: absolute;right: 0;top: 0;width:516px;height: 26px;}", '#popclosed {background: url("http://jifen.sina.com.cn/jifen/images/v1.5/x.jpg") no-repeat scroll 0 0 rgba(0, 0, 0, 0);display: block;height: 24px;float:right;width: 24px;}',        //								".outlogin_layerbox_bylx .cur_move{position:relative!important;width:477px!important;height:17px!important;cursor:move;left:0!important;clear:both!important;}",
        '.outlogin_layerbox_bylx a.layerbox_close{position:absolute!important;right:8px!important;top:8px!important;width:12px!important;height:11px!important;padding:5px!important;font:700 12px "Simsun"!important;text-decoration:none!important;overflow:hidden!important;z-index:10!important;}', '.outlogin_layerbox_bylx .close_loginname{position:absolute!important;width:11px!important;height:11px!important;padding:5px!important;left:180px!important;top:4px!important;font:700 12px "Simsun"!important;text-decoration:none!important;overflow:hidden!important;}', ".outlogin_layerbox_bylx a.layerbox_close:hover{text-decoration:none!important;}",        //								".outlogin_layerbox_bylx .layerbox_left{width:259px!important;display:inline!important;float:right!important;margin-top:-17px!important;height:260px;padding:17px 0 17px 30px!important;border-right-width:1px!important;border-right-style:solid!important;}",
        ".outlogin_layerbox_bylx .cright{width:282px!important;display:inline!important;float:right!important;}", ".outlogin_layerbox_bylx .cright .titletips{padding:8px 0 35px!important;}", ".outlogin_layerbox_bylx .cright", ".outlogin_layerbox_bylx .cright h2{font-size: 16px; font-weight: normal; margin: 0 0 10px; }", ".outlogin_layerbox_bylx .cright label{display: block;  height: 34px; margin: 0 0 13px; position: relative; }", ".outlogin_layerbox_bylx .cright label input{border: none; text-indent: 45px; padding: 5px 8px 5px 0; line-height: 24px; font-size: 14px;  border: 1px solid #dcdcdc; display: block; width: 272px; height: 24px;}", ".outlogin_layerbox_bylx .cright label i{width: 36px; height: 36px; position: absolute; left: 0; top: 0; background: url(http://jifen.sina.com.cn/jifen/images/v1.5/logincoin.jpg) no-repeat;}", ".outlogin_layerbox_bylx .cright .password i{background-position: 0 -36px;}", ".outlogin_layerbox_bylx .cright a.loginbtn{display: block; width: 100%; height: 40px; background-color: #ff4401; text-align: center; line-height: 40px; font-size: 18px; color: #ffffff; margin: 14px 0 8px;}", ".outlogin_layerbox_bylx .cright a.loginbtn:hover{background-color: #fa6b38;}", ".outlogin_layerbox_bylx .other1 a{float: right;}", ".outlogin_layerbox_bylx .other1 .c{vertical-align: middle;}", ".outlogin_layerbox_bylx .other2 a.weibologin{display: inline-block; line-height: 22px; height: 22px; background: url(http://jifen.sina.com.cn/jifen/images/v1.5/sprite.png) no-repeat 0 -191px; padding-left: 30px;}", ".outlogin_layerbox_bylx .other2 a.register{float: right;}",        //								".outlogin_layerbox_bylx .layerbox_left ul.loginformlist{list-style:none!important;padding:0!important;margin:0!important;}",
        ...
        ".outlogin_layerbox_bylx .otwo_d_wrap{float: left; font-size: 16px; overflow: hidden; width: 192px;}", ".outlogin_layerbox_bylx .otwo_d_wrap img{height:192px;width:192px;border:none!important;display:inline!important;margin-top:10px;}",        //								".outlogin_layerbox_bylx .otwo_d_wrap .otwo_tl{height:40px!important;padding:8px 0 0 26px!important;}",
        ...
        //								".outlogin_layerbox_bylx .layerbox_left ul.loginformlist li span a span.qq_login_logo {display: inline-block;width: 16px;height: 16px;margin-right: 5px;background-image: url(http://i.sso.sina.com.cn/images/login/qq.png);background-repeat: no-repeat;vertical-align: middle;}" 
                ...
                if (k.root && n) {
                    ...
                    if (h.direction == "right") {
                        ...
                        if (h.direction == "bottom") {
                            ...
                            if (h.direction == "left") {
                                l.left = p.left - o.width -
                                h.margin
                            }
                            else {
                                l.top = p.top - o.height -
                                h.margin
                            }
                        }
                    }
                    if (h.use_relative) {
                        ...
                        d.setStyle(k.root, "left", l.left +
                        "px")
                    }
                    else {
                        d.setStyle(k.root, "marginTop", l.top +
                        "px");
                        d.setStyle(k.root, "marginLeft", l.left +
                        "px")
                    }
                }
            };
        ...
        return function(q, n){
            ...
            p.buildLayer = function(){
                ...
                if (!o.box_styles.width) {
                    o.box_styles.width = k(m.input).width - 2 +
                    "px"
                }
                p.layer = e({
                    template: t,
                ...
                h.foreach(m.items, function(v){
                    var u = v.getAttribute("data-email") ||
                    "empty";
                    p.items[u] = v;
    ...
    a.register("comp.layer.outlogin", function(j){
        ...
        var t = {};
        var d = {
            layer: ['<div node-type="box" class="outlogin_layerbox_bylx outlogin_layerbox_bylx_anrrow" style="display:none;">', "#L{iframemask}", '<div class="hide">', '<div node-type="qrcode_help" class="otwo_hlp" style="display:none;">', '<div class="hlp_cnt">', '<div class="otwo_hlp_tl">用此功能扫描二维码快速登录</div>', '<div class="ot_wrap">', '<img src="http://i.sso.sina.com.cn/images/login/weibo_how_ot.png">', "</div>", "</div>", '<span class="ot_arrow"></span>', "</div>", '<p node-type="phone_tip" class="login_recom_tips" style="visibility:hidden;">绑定手机号也能登录了。<a href="http://help.weibo.com/faq/q/1576/15471" target="_blank">详情</a></p>', '<li class="ndrelativewrap" node-type="prelogin_area" style="display:none;">', '<span class="pre_name" node-type="prelogin_name">加载中...</span>', '<a href="javascript:;" class="chg_ac" node-type="prelogin_changeAccount">换个账号登录</a>', "</li>", '<li class="sub_wrap_r">', '<span class="qq_spanoption" style="display:none;">', '<a class="qq_login_h" node-type="qq_login" href="#" suda-uatrack="key=index_new_menu&value=logon_qq">', '<span class="qq_login_logo"></span>', '<span class="qq_login">#L{使用QQ登录}</span>', "</a>", "</span>", "</li>", '</div>', '<div class="cur_move" node-type="handle">', '<a id="popclosed" node-type="close" href="javascript:;" onclick="return false;" class="layerbox_close"></a>', "</div>", '<div class="otwo_d_wrap" node-type="layerleft_qrcode">', "微博客户端扫描二维码登录", '<img node-type="qrcode_img" src="http://i.sso.sina.com.cn/images/login/td.png">', "</div>",            //										'<div node-type="root" class="layerbox_left">',
            '<div node-type="root" class="cright">',            //											'<div class="titletips" node-type="titletips" >#L{帐号登录}</div>',
            '<h2 node-type="titletips">#L{帐号登录}</h2>', '<p node-type="tip" class="login_error_tips" style="visibility:hidden;"></p>', '<label class="username" node-type="loginname_box">', '<input node-type="loginname" name="loginname" class="styles" type="text" placeholder="#L{新浪微博/新浪博客/新浪邮箱/手机号}" tabindex="1" maxlength="128" autocomplete="off" autocapitalize="off"/>', '<i></i>', '</label>', '<label class="password" node-type="password_box">', '<input node-type="password" name="password" class="styles" type="password" placeholder="#L{请输入密码}" tabindex="2" maxlength="24"/>', '<i></i>', '</label>', '<label class="password" node-type="door_box" style="display:none;">', '<input node-type="door" name="door" class="styles" type="text" tabindex="3" maxlength="6" autocomplete="off" autocapitalize="off"/>', '<img node-type="door_img" class="yzm" alt="#L{看不清？换一换}"/>', '<a node-type="door_change" href="javascript:;" class="reload-code" title="#L{看不清？换一换}"></a>', '<a node-type="door_voice" href="javascript:;" class="disability_voice" style="display:none;"></a>', '</label>', '<label class="password" node-type="vsn_box" style="display:none;">', '<input node-type="vsn" name="vsn" class="styles" type="text" tabindex="4" maxlength="6" placeholder="#L{请输入微盾动态码}" autocomplete="off" autocapitalize="off"/>', '</label>', '<div class="other1">', '<a node-type="forgot_password" href="https://security.weibo.com/iforgot/loginname?entry=weibo" target="_blank" suda-uatrack="key=index_new_menu&value=logon_forgot">#L{忘记密码？}</a>', '<input type="checkbox" class="c" name="remember" node-type="remember" checked="checked" autocomplete="off" /> 下次自动登录', '</div>', '<a href="javascript:;" tabindex="5" node-type="submit" class="loginbtn" suda-uatrack="key=index_new_menu&value=logon_login">#L{登录}</a>', '<div class="other2">', '<a class="register" node-type="register_button" target="_blank" href="https://login.sina.com.cn/signup/signup.php" suda-uatrack="key=index_new_menu&value=logon_register">#L{免费注册}</a>', '<a class="weibologin" href="http://weibo.com/">新浪微博登录</a>', '</div>',            //											'<p node-type="phone_tip" class="login_recom_tips" style="visibility:hidden;">绑定手机号也能登录了。<a href="http://help.weibo.com/faq/q/1576/15471" target="_blank">详情</a></p>',
            //											'<ul class="loginformlist">',
            //												'<li class="ndrelativewrap" node-type="prelogin_area" style="display:none;">',
            //													'<span class="pre_name" node-type="prelogin_name">加载中...</span>',
            //													'<a href="javascript:;" class="chg_ac" node-type="prelogin_changeAccount">换个账号登录</a>',
            //												"</li>",
            //												'<li class="ndrelativewrap" node-type="loginname_box">',
            //													'<input node-type="loginname" name="loginname" class="styles" type="text" placeholder="#L{新浪微博/新浪博客/新浪邮箱/手机号}" tabindex="1" maxlength="128" autocomplete="off" autocapitalize="off"/>',
            //													'<a node-type="clear" href="javascript:;" class="close_loginname" style="display:none;">&times;</a>',
            //												"</li>",
            //												'<li node-type="password_box">',
            //													'<input node-type="password" name="password" class="styles" type="password" placeholder="#L{请输入密码}" tabindex="2" maxlength="24"/>',
            //												"</li>",
            //												'<li class="loginform_yzm" node-type="door_box" style="display:none;">',
            //													'<input node-type="door" name="door" class="styles" type="text" tabindex="3" maxlength="6" autocomplete="off" autocapitalize="off"/>',
            //													'<img node-type="door_img" class="yzm" alt="#L{看不清？换一换}"/>',
            //													'<a node-type="door_change" href="javascript:;" class="reload-code" title="#L{看不清？换一换}"></a>',
            //													'<a node-type="door_voice" href="javascript:;" class="disability_voice" style="display:none;"></a>',
            //												"</li>",
            //												'<li node-type="vsn_box" style="display:none;">',
            //													'<input node-type="vsn" name="vsn" class="styles" type="text" tabindex="4" maxlength="6" placeholder="#L{请输入微盾动态码}" autocomplete="off" autocapitalize="off"/>',
            //												"</li>",
            //												'<li class="sub_wrap_r">',
            //													'<span class="btn_wrap">',
            //														'<a href="javascript:;" tabindex="5" node-type="submit" class="login_btn" suda-uatrack="key=index_new_menu&value=logon_login">#L{登录}</a>',
            //														'<label node-type="remember_label" class="rmb_login">',
            //															'<input name="remember" node-type="remember" type="checkbox" class="auto_checkbox" checked="checked" autocomplete="off"/>',
            //															"<span>#L{下次自动登录}</span>",
            //														"</label>",
            //													"</span>",
            //												"</li>",
            //												'<li class="sub_wrap_r">',
            //													'<span class="log_option">',
            //														'<a class="forget_Pwd" node-type="forgot_password" href="http://login.sina.com.cn/getpass.html" target="_blank" suda-uatrack="key=index_new_menu&value=logon_forgot">#L{忘记密码}</a>',
            //														'<a class="register_lnk" node-type="register_button" target="_blank" href="https://login.sina.com.cn/signup/signup.php" suda-uatrack="key=index_new_menu&value=logon_register">#L{立即注册}</a>',
            //													"</span>",
            //												"</li>",
            //												'<li class="sub_wrap_r">',
            //													'<span class="qq_spanoption" style="display:none;">',
            //														'<a class="qq_login_h" node-type="qq_login" href="#" suda-uatrack="key=index_new_menu&value=logon_qq">',
            //															'<span class="qq_login_logo"></span>',
            //															'<span class="qq_login">#L{使用QQ登录}</span>',
            //														"</a>",
            //													"</span>",
            //												"</li>",
            //											"</ul>",
            "</div>", '<div class="otwo_d_wrap" node-type="layerleft_preloginThumb" style="display:none;">', '<div class="otwo_tl"></div>', '<div class="td_wrap">', '<span class="thumb"><img node-type="prelogin_img" src="http://i.sso.sina.com.cn/images/login/pre_loading.gif"></span>', "</div>", "</div>", '<div node-type="qrcode_tip" class="swip_check" style="display:none;">', '<span class="swip_check_cls" node-type="qrcode_tip_close"></span>', '<span class="swip_check_icon"></span>', '<p class="swip_check_txt">扫描成功！<br>手机上点击确认以登录</p>', '<span class="swip_check_btmarow"></span>', "</div>", '<div node-type="css_check" class="outlogin_checkload" style="display:none;"></div>', "</div>"].join(""),
        ...
        var g = {
            ...
            suggestor: {
                ...
                format_set: function(F){
                    return '<a href="javascript:;" onclick="return false">' +
                    j.encodeHTML(F) +
                    "</a>"
                },
                ...
                if (F && F.autoLogin) {
                    F.autoLogin(function(){
                        ...
                        if (l.isLogin()) {
                            ...
                            if (l.isPreLoginState &&
                            location.href.indexOf("http://www.sina.com.cn") <
                            0) {
        ...
        v.build = function(){
            ...
            if (g.plugin.qqLogin) {
                ...
                t.qq_login.href = "https://passport.weibo.com/othersitebind/authorize?site=qq&wl=1&entry=" +
                g.sso.entry +
                "&callback=" +
        ...
        v.insert = function(){
            ...
            if (!j.isNode(t.box.parentNode) ||
            F !== v._currentParentNode) {
                F.appendChild(t.box)
            }
        ...
        v.parseDom = function(){
            if (!j.isNode(t.box)) {
                if (j.core.util.browser.IE6 &&
                g.plugin.useIframeInIE6) {
        ...
        v.setPosition = function(){
            ...
            if (t.iframemask) {
                ...
                H = parseInt(H, 10);
                j.setStyle(t.iframemask, "width", L.width +
                "px");
                j.setStyle(t.iframemask, "height", L.height +
                "px");
                j.setStyle(t.iframemask, "marginLeft", 0 - H +
                "px");
                j.setStyle(t.iframemask, "marginTop", 0 - H +
                "px")
            }
        };
        l.reset = function(){
